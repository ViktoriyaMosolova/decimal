...
int s21_add(s21_decimal value_1, s21_decimal value_2, s21_decimal *result) {
  short err = 0, sign_1 = getSign(value_1),
        sign_2 = getSign(value_2);
  unsigned int scale = 0;
  big_decimal val_1 = {{value_1.bits[0], value_1.bits[1],
                             value_1.bits[2], 0, 0, 0}},
                   val_2 = {{value_2.bits[0], value_2.bits[1],
                             value_2.bits[2], 0, 0, 0}},
                   res = {0};
  cast_scale(&value_1, &value_2);
  scale = getScale(value_1);
  setSign(&value_1, 0); setSign(&value_2, 0);
